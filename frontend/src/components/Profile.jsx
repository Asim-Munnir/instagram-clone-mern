...
const Profile = () => {
  ...
  const isFollowing = false // userProfile.followers.includes(user?._id)
      ...
      <div className='flex flex-col gap-20 p-8'>
          ...
          <section>
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex items-center gap-2'>
                <span>{userProfile?.username.charAt(0).toUpperCase() + userProfile?.username.slice(1)}</span>
                {
                  isLoggedInUserProfile ? (
                    ...
                    isFollowing ? (
                      <>
                        ...
                        <Button variant="secondary" className="h-8">Message <Send /></Button>
                      </>
                    ) : (
              ...
              <div className='flex flex-col gap-1'>
                <span className='font-semibold'>{userProfile?.bio.charAt(0).toUpperCase() + userProfile.bio.slice(1) || 'bio here...'}</span>
        ...
        <div className='border-t border-t-gray-200'>
          ...
          <div className='grid grid-cols-3 gap-1'>
            {
              displayedPost.length === 0 ? <h1>No Posts.</h1> :
                displayedPost.map((post) => {
                  return (
                    <div key={post?._id} className='relative group cursor-pointer'>
                      <div>
                        <img src={post.image} className='rounded-lg my-2 w-full aspect-square object-cover' alt="" />
